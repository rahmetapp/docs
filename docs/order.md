...
- <sup>8</sup> Если сервис работает внутри приложения Рахмет (к примеру, миниапп), то необходимо передать значение "miniapp", если запрос приходит из внешнего сервиса (приложение) то необходимо передать "external"
